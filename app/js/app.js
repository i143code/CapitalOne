...
(function() {
    ...
    geocoder.$inject =['$rootScope'];
    GMapController.$inject = ['$timeout','$scope'];
    ListMapController.$inject = ['$timeout','$scope','geocoder'];

    function geocoder($rootScope) {
        this.geocode=function( outerCallback) {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position){
                    $rootScope.$apply(function(){
                        outerCallback( position);
                    });
                });
            }
        };
    }
    function GMapController($timeout, $scope) {
        var vm = this;
        activate();
        function activate() {
    ...
    function ListMapController($timeout, $scope, geocoder){
        var vm = this;
        $scope.priceSlider = {
            min: 0,
            max: 100,
        ...
        $scope.persons = [
            {
                name: 'Lesa Chin',
                skills: 'Plumber',
                description: 'I am a really good plumber comes at affordable price',
                image: 'app/img/img1.jpg',
                rating: 4
            },
            {
                name: 'Markio Sharkey',
                skills: 'Bar tender',
                description: 'I am a really good bartender and funny',
                image: 'app/img/img2.jpg',
                rating: 2
            },
            {
                name: 'Janna Rojero',
                skills: 'Musician',
                description: 'Guitar player and a good singer',
                image: 'app/img/img3.jpg',
                rating: 1
            },
            {
                name: 'Leslee Scannell',
                skills: 'Waiter',
                description: 'I am a really good plumber comes at affordable price',
                image: 'app/img/img4.jpg',
                rating: 4
            },
            {
                name: 'Christal Goulette',
                skills: 'Plumber',
                description: 'I am a really good plumber comes at affordable price',
                image: 'app/img/img5.jpg',
                rating: 2
            },
            {
                name: 'Ashlea Ruis',
                skills: 'Bar tender',
                description: 'I am a really good bartender and funny',
                image: 'app/img/img6.jpg',
                rating: 4
            },
            {
                name: 'Jeanna Wheeling',
                skills: 'Musician',
                description: 'Guitar player and a good singer',
                image: 'app/img/img7.jpg',
                rating: 5
            },
            {
                name: 'Nilsa Petti',
                skills: 'Waiter',
                description: 'I am a really good plumber comes at affordable price',
                image: 'app/img/img8.jpg',
                rating: 5
            },
            {
                name: 'Rosemarie Stefanski',
                skills: 'Plumber',
                description: 'I am a really good plumber comes at affordable price',
                image: 'app/img/img9.jpg',
                rating: 4
            }
        ];
        ...
        geocoder.geocode( function(callbackResult) {
            var lat = roundNumber(callbackResult.coords.latitude,6);
            var long =roundNumber(callbackResult.coords.longitude,6);
            var position = [
            ...
            // we use timeout to wait maps to be ready before add a markers
            //$timeout(function(){
                marker = addMarker(vm.myMap1, position[0]);
            //});
             var map =  vm.myMap1;
